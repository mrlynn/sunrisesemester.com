...
export default function SubscribeConfirmClient({ token }) {
  ...
  return (
    <Container maxWidth="sm" sx={{ py: { xs: 5, md: 8 } }}>
      ...
      {loading ? (
        <Typography color="text.secondary">Confirming your subscription…</Typography>
      ) : null}
      ...
      {error ? (
        <Stack spacing={3}>
          ...
          <Button component={Link} href="/subscribe" variant="contained">
